...
internal class MessageLocalDataSource(private val messageDao: MessageDao) {
    ...
    suspend fun deleteMessage(message: Message) {
        withContext(Dispatchers.IO) {
            messageDao.deleteMessage(message.toLocal())
        }
    }
