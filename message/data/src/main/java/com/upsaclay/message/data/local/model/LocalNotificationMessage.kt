...
data class LocalNotificationMessage(
    ...
    @ColumnInfo(name = TIMESTAMP) val messageTimestamp: Long,
    @ColumnInfo(name = CONVERSATION_ID) val conversationId: String,
    @ColumnInfo(name = INTERLOCUTOR_ID) val interlocutorId: String,
    @ColumnInfo(name = INTERLOCUTOR_FIRST_NAME) val interlocutorFirstName: String,
    @ColumnInfo(name = INTERLOCUTOR_LAST_NAME) val interlocutorLastName: String,
    @ColumnInfo(name = INTERLOCUTOR_EMAIL) val interlocutorEmail: String,
    @ColumnInfo(name = INTERLOCUTOR_SCHOOL_LEVEL) val interlocutorSchoolLevel: String,
    @ColumnInfo(name = INTERLOCUTOR_IS_MEMBER) val interlocutorIsMember: Boolean,
    @ColumnInfo(name = INTERLOCUTOR_PROFILE_PICTURE_FILE_NAME) val interlocutorProfilePictureFileName: String?,
    @ColumnInfo(name = INTERLOCUTOR_IS_DELETED) val interlocutorIsDeleted: Boolean,
    @ColumnInfo(name = CREATED_AT) val createdAt: Long,
    @ColumnInfo(name = CONVERSATION_STATE) val conversationState: String,
    @ColumnInfo(name = CONVERSATION_DELETE_TIME) val conversationDeleteTime: Long?,
)
