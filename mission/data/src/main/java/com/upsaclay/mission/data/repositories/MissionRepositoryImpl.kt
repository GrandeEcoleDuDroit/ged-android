...
class MissionRepositoryImpl(
    ...
    override val missions: Flow<List<Mission>> = missionLocalDataSource.getMissionsFlow()
    ...
    override suspend fun getLocalMissions(): List<Mission> =
        missionLocalDataSource.getMissions()
