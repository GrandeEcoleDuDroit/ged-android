...
fun EditMissionDestination(
    ...
    EditMissionScreen(
        ...
        schoolLevelSupportingText = uiState.schoolLevelSupportingText,
        maxParticipantsError = uiState.maxParticipantsError,
        users = uiState.users,
...
private fun EditMissionScreen(
    ...
    schoolLevelSupportingText: Int?,
    maxParticipantsError: Int?,
    users: List<User>,
    userQuery: String,
    imageUri: Uri?,
    ...
    Scaffold(
        ...
        MissionForm(
            ...
            value = MissionFormValue(
                ...
                maxParticipantsError = maxParticipantsError?.let { stringResource(it, participants.size) }
            ),
