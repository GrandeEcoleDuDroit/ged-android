...
import com.upsaclay.news.data.announcement.AnnouncementField.Local.ANNOUNCEMENT_AUTHOR_ADMIN
import com.upsaclay.news.data.announcement.AnnouncementField.Local.ANNOUNCEMENT_AUTHOR_EMAIL
import com.upsaclay.news.data.announcement.AnnouncementField.Local.ANNOUNCEMENT_AUTHOR_FIRST_NAME
import com.upsaclay.news.data.announcement.AnnouncementField.Local.ANNOUNCEMENT_AUTHOR_ID
import com.upsaclay.news.data.announcement.AnnouncementField.Local.ANNOUNCEMENT_AUTHOR_LAST_NAME
import com.upsaclay.news.data.announcement.AnnouncementField.Local.ANNOUNCEMENT_AUTHOR_PROFILE_PICTURE_FILE_NAME
import com.upsaclay.news.data.announcement.AnnouncementField.Local.ANNOUNCEMENT_AUTHOR_SCHOOL_LEVEL
import com.upsaclay.news.data.announcement.AnnouncementField.Local.ANNOUNCEMENT_AUTHOR_STATE
import com.upsaclay.news.data.announcement.AnnouncementField.Local.ANNOUNCEMENT_AUTHOR_TESTER
import com.upsaclay.news.data.announcement.AnnouncementField.Local.ANNOUNCEMENT_CONTENT
...
import com.upsaclay.news.data.announcement.AnnouncementField.Local.ANNOUNCEMENT_STATE
import com.upsaclay.news.data.announcement.AnnouncementField.Local.ANNOUNCEMENT_TABLE_NAME
import com.upsaclay.news.data.announcement.AnnouncementField.Local.ANNOUNCEMENT_TITLE
